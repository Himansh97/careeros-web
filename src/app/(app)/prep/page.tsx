...
import { Braces, GraduationCap, Mic, PlugZap, Radar, RotateCcw, Sparkles, Square } from "lucide-react";
...
export default function PrepPage() {
  ...
  if (!isLiveApi()) {
    return (
      <>
        <PageHeader title="Interview prep" description="Practice, checked against your evidence." action={<><Button asChild variant="outline"><Link href="/prep/learn"><GraduationCap className="size-4" /> Learn</Link></Button><Button asChild variant="outline"><Link href="/prep/concepts"><Sparkles className="size-4" /> Concepts</Link></Button><Button asChild variant="outline"><Link href="/prep/technical"><Braces className="size-4" /> Technical lab</Link></Button></>} />
        <EmptyState
          icon={PlugZap}
          title="Not connected"
  ...
  return (
    <>
      <PageHeader
        ...
        action={<><Button asChild variant="outline"><Link href="/prep/learn"><GraduationCap className="size-4" /> Learn</Link></Button><Button asChild variant="outline"><Link href="/prep/concepts"><Sparkles className="size-4" /> Concepts</Link></Button><Button asChild variant="outline"><Link href="/prep/technical"><Braces className="size-4" /> Technical lab</Link></Button></>}
      />
